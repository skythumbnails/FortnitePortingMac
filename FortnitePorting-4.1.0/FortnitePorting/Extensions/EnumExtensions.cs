...
// Same as EnumToItemsSource but excludes [Disabled] members entirely (not greyed). Used for the
// macOS FortniteVersion picker, where LatestInstalled and Custom aren't supported and should be
// hidden from the dropdown rather than shown disabled.
